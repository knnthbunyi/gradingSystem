  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="gradingSystemApp.subject.home.createOrEditLabel" data-cy="SubjectCreateUpdateHeading">
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField label="Name" id="subject-name" name="name" data-cy="name" type="text" />
              <ValidatedField label="Code" id="subject-code" name="code" data-cy="code" type="text" />
