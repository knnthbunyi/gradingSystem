package com.grading.system.web.rest.errors;
...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof com.grading.system.service.EmailAlreadyUsedException ||
            ex instanceof com.grading.system.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof com.grading.system.service.InvalidPasswordException
    ...
    private boolean containsPackageName(String message) {
        ...
        return StringUtils.containsAny(message, "org.", "java.", "net.", "jakarta.", "javax.", "com.", "io.", "de.", "com.grading.system");
    }
}
